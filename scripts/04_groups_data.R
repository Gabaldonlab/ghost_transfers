...
write.table(simulations, '../outputs/all_simulations.tsv', sep = '\t', quote = FALSE)
...
write.table(donor_correspondences, '../outputs/ancestors_correspondence.tsv', sep = '\t', quote = FALSE)
...
write.table(shift / total, file = '../outputs/shiftprop_clades_matrix.tsv',
            sep = '\t', row.names = TRUE, col.names = TRUE, quote = FALSE)

pheatmap(shift / total, na_col = 'white', cellheight = 12, cellwidth = 12,
         breaks = 0:100/100, cluster_cols = 2, cluster_rows = 2, cutree_rows = 3,
         cutree_cols = 3, filename = '../outputs/heatmap.pdf')
